...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Ápr 24. 18:57
...
CREATE TABLE `allomas` (
  ...
  `allomasSorszam` int(11) NOT NULL
...
CREATE TABLE `naptipus` (
  `napTipusSorszam` int(11) NOT NULL,
...
--
ALTER TABLE `allomas`
  ADD PRIMARY KEY (`allomasSorszam`);

--
-- A tábla indexei `erint`
--
ALTER TABLE `erint`
  ADD PRIMARY KEY (`erintSorszam`),
  ADD KEY `allomasSorszam` (`allomasSorszam`),
  ADD KEY `vonalSorszam` (`vonalSorszam`);

--
-- A tábla indexei `jarat`
--
ALTER TABLE `jarat`
  ADD PRIMARY KEY (`jaratSorszam`),
  ADD KEY `vonalSorszam` (`vonalSorszam`),
  ADD KEY `jarmuSorszam` (`jarmuSorszam`),
  ADD KEY `napTipusSorszam` (`napTipusSorszam`);

--
-- A tábla indexei `jarmu`
--
ALTER TABLE `jarmu`
  ADD PRIMARY KEY (`jarmuSorszam`);

--
-- A tábla indexei `naptipus`
--
ALTER TABLE `naptipus`
  ADD PRIMARY KEY (`napTipusSorszam`);

--
-- A tábla indexei `vonal`
--
ALTER TABLE `vonal`
  ADD PRIMARY KEY (`vonalSorszam`),
  ADD KEY `kezdoAllomasSorszam` (`kezdoAllomasSorszam`),
  ADD KEY `vegAllomasSorszam` (`vegAllomasSorszam`);
...
--
ALTER TABLE `allomas`
  MODIFY `allomasSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT a táblához `erint`
--
ALTER TABLE `erint`
  MODIFY `erintSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT a táblához `jarat`
--
ALTER TABLE `jarat`
  MODIFY `jaratSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT a táblához `jarmu`
--
ALTER TABLE `jarmu`
  MODIFY `jarmuSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT a táblához `naptipus`
--
ALTER TABLE `naptipus`
  MODIFY `napTipusSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT a táblához `vonal`
--
ALTER TABLE `vonal`
  MODIFY `vonalSorszam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
